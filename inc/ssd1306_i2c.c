...
void limpar_oled()
{
    ...
    memset(ssd1306_buffer, 0, SSD1306_BUFFER_LENGTH);           // Preenche o buffer global com zeros
    ssd1306_send_buffer(ssd1306_buffer, ssd1306_buffer_length); // Envia o buffer limpo para o display
}